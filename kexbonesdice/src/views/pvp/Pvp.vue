  ...
  <div class="gameContainer">
    ...
    <div class="gameArea">
      <div class="playerAArea">
        <div class="rowK Arow" v-if="updata" @click="pushAK">
          <div
        ...
        <div class="rowE Arow" v-if="updata" @click="pushAE">
          <div
        ...
        <div class="rowX Arow" v-if="updata" @click="pushAX">
          <div
      ...
      <div class="playerBArea">
        <div class="rowK Brow" v-if="updata" @click="pushBK">
          <div
        ...
        <div class="rowE Brow" v-if="updata" @click="pushBE">
          <div
        ...
        <div class="rowX Brow" v-if="updata" @click="pushBX">
          <div
